    ...
    <footer className="bg-card border-t">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <Link to="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-lg font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-stem-teal">
                STEMplexus
              </span>
            </Link>
            <p className="text-foreground/70 mb-4">
              Revolutionizing STEM education through AI-powered personalized learning.
            </p>
          ...
          <div className="md:col-span-3 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link to="/subjects" className="text-foreground/70 hover:text-primary transition-colors">Subjects</Link></li>
                <li><Link to="/challenges" className="text-foreground/70 hover:text-primary transition-colors">Challenges</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link to="/tutorials" className="text-foreground/70 hover:text-primary transition-colors">Tutorials</Link></li>
                <li><Link to="/faqs" className="text-foreground/70 hover:text-primary transition-colors">FAQs</Link></li>
                <li><Link to="/support" className="text-foreground/70 hover:text-primary transition-colors">Support</Link></li>
              </ul>
            </div>
        ...
        <div className="border-t mt-12 pt-8 text-center text-foreground/60">
          <p>&copy; {new Date().getFullYear()} STEMplexus. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
